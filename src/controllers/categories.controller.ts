...
export default class CategoryController {
	async getCategories(req: IGetAuthTypesRequest, res: Response) {
		...
		const total_records = await CATEGORY.count();
		...
		try {
			...
			addLog("Categories", user_unique_id, "Queried Categories", queryParams);
			if (response.count === 0) {
				return SuccessResponse(res, { unique_id: user_unique_id, text: "Categories Not found" }, []);
			} else {
				return SuccessResponse(res, { unique_id: user_unique_id, text: "Categories loaded" }, { ...response, pages: pagination.pages });
			}
		} catch (err: any) {
	...
	async getCategory(req: IGetAuthTypesRequest, res: Response) {
		const user_unique_id: string = req.USER_UNIQUE_ID;
		...
		try {
			...
			addLog("Categories", user_unique_id, "Queried Category", queryParams);
			if (!response) {
				return SuccessResponse(res, { unique_id: user_unique_id, text: "Category Not found" }, null);
			} else {
				return SuccessResponse(res, { unique_id: user_unique_id, text: "Category loaded" }, response);
			}
		} catch (err: any) {
			return ServerError(res, { unique_id: user_unique_id, text: err.message }, null);
		}
	...
	async searchCategories(req: IGetAuthTypesRequest, res: Response) {
		const user_unique_id: string = req.USER_UNIQUE_ID;
		...
		try {
			...
			addLog("Categories", user_unique_id, "Searched Categories", queryParams);
			if (response.count === 0) {
				return SuccessResponse(res, { unique_id: user_unique_id, text: "Categories Not found" }, []);
			} else {
				return SuccessResponse(res, { unique_id: user_unique_id, text: "Categories loaded" }, { ...response, pages: pagination.pages });
	...
	async getCategoriesSpecifically(req: IGetAuthTypesRequest, res: Response) {
		const user_unique_id: string = req.USER_UNIQUE_ID;
		...
		const total_records = await CATEGORY.count({ where: dynamicWhere(queryParams) });
		const pagination = paginate(queryParams.page || parseInt(req.body.page), queryParams.size || parseInt(req.body.size), total_records);
		const orderBy = queryParams.orderBy || req.body.orderBy || "createdAt";
		const sortBy = return_all_letters_uppercase(queryParams.sortBy) || return_all_letters_uppercase(req.body.sortBy) || "DESC";
		...
		try {
			...
			addLog("Categories", user_unique_id, "Queried Categories specifically", queryParams);
			if (response.count === 0) {
				return SuccessResponse(res, { unique_id: user_unique_id, text: "Categories Not found" }, []);
			} else {
				return SuccessResponse(res, { unique_id: user_unique_id, text: "Categories loaded" }, { ...response, pages: pagination.pages });
	...
	async filterCategoriesSpecifically(req: IGetAuthTypesRequest, res: Response) {
		const user_unique_id: string = req.USER_UNIQUE_ID;
		...
		try {
			...
			addLog("Categories", user_unique_id, "Filtered Categories specifically", queryParams);
			if (response.count === 0) {
				return SuccessResponse(res, { unique_id: user_unique_id, text: "Categories Not found" }, []);
			} else {
				return SuccessResponse(res, { unique_id: user_unique_id, text: "Categories loaded" }, { ...response, pages: pagination.pages });
	...
	async publicGetCategories(req: IGetAuthTypesRequest, res: Response) {
		const queryParams: IPagination = req.query;

		const total_records = await CATEGORY.count({ where: { status: default_status } });
		const pagination = paginate(queryParams.page || parseInt(req.body.page), queryParams.size || parseInt(req.body.size), total_records);
		const orderBy = queryParams.orderBy || req.body.orderBy || "createdAt";
		const sortBy = return_all_letters_uppercase(queryParams.sortBy) || return_all_letters_uppercase(req.body.sortBy) || "DESC";
		...
		try {
			...
			if (response.count === 0) {
				return SuccessResponse(res, { unique_id: anonymous, text: "Categories Not found" }, []);
			} else {
				// return SuccessResponse(res, { unique_id: anonymous, text: "Categories loaded" }, { ...response, pages: pagination.pages });
				return SuccessResponse(res, { unique_id: anonymous, text: "Categories loaded" }, { ...response });
			}
		} catch (err: any) {
	...
	async publicGetCategory(req: IGetAuthTypesRequest, res: Response) {
		const errors = validationResult(req);
		const payload = matchedData(req);
		...
		try {
			...
			if (!response) {
				return SuccessResponse(res, { unique_id: anonymous, text: "Category Not found" }, null);
			} else {
				return SuccessResponse(res, { unique_id: anonymous, text: "Category loaded" }, response);
			}
		} catch (err: any) {
			return ServerError(res, { unique_id: anonymous, text: err.message }, null);
		}
	...
	async publicSearchCategories(req: IGetAuthTypesRequest, res: Response) {
		const queryParams: IPagination = req.query;
	...
	async addCategory(req: IGetAuthTypesRequest, res: Response) {
		const user_unique_id: string = req.USER_UNIQUE_ID;
		...
		try {
			...
			await CATEGORY.sequelize?.transaction(async (transaction) => {
				...
				addLog("Categories", user_unique_id, "Added Category", payload);
				if (categoryResponse) {
					return SuccessResponse(res, { unique_id: user_unique_id, text: "Category created successfully!" }, { unique_id: category_unique_id });
				} else {
	...
	async updateCategoryDetails(req: IGetAuthTypesRequest, res: Response) {
		const user_unique_id: string = req.USER_UNIQUE_ID;
		...
		try {
			await CATEGORY.sequelize?.transaction(async (transaction) => {
				...
				addLog("Categories", user_unique_id, "Updated Category Details", payload);
				if (response[0] > 0) {
	...
	async deleteCategory(req: IGetAuthTypesRequest, res: Response) {
		const user_unique_id: string = req.USER_UNIQUE_ID;
		...
		try {
			await CATEGORY.sequelize?.transaction(async (transaction) => {
				...
				addLog("Categories", user_unique_id, "Deleted Category", payload);
				if (response > 0) {
					return SuccessResponse(res, { unique_id: user_unique_id, text: "Category was deleted successfully!" }, null);
				} else {
